const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['assets/AboutView-DyEowPLc.js', 'assets/AboutView-CSIvawM9.css']),
) => i.map((i) => d[i])
;(function () {
...
const te = {},
  ...
  Sr = (e) => (se(e) || V(e)) && V(e.then) && V(e.catch),
...
const Tr = (e) => !!(e && e.__v_isRef === !0),
  Mr = (e) =>
    re(e)
      ...
      : e == null
        ? ''
        : F(e) || (se(e) && (e.toString === Rr || !V(e.toString)))
          ? Tr(e)
            ? Mr(e.value)
...
function Ii(e, t, n = !1) {
  let s, r
  return V(e) ? (s = e) : ((s = e.get), (r = e.set)), new Mi(s, r, n)
}
const un = {},
  pn = new WeakMap()
let pt
...
function Hi(e, t, n = te) {
  ...
  const D = ui(),
    H = () => {
      a.stop(), D && D.active && cs(D.effects, a)
    }
  if (o && t) {
    const T = t
    t = (...J) => {
...
function el(e) {
  ...
  if (((Jn = !0), o))
    for (const Y in o) {
      const U = o[Y],
        Be = V(U) ? U.bind(n, n) : V(U.get) ? U.get.bind(n, n) : De,
        et = !V(U) && V(U.set) ? U.set.bind(n) : De,
        ze = Ce({ get: Be, set: et })
  ...
  return function (s, r = null) {
    ...
    const h = (o.app = {
      ...
      use(a, ...d) {
        return (
          i.has(a) ||
            (a && V(a.install) ? (i.add(a), a.install(h, ...d)) : V(a) && (i.add(a), a(h, ...d))),
          h
        )
      },
      mixin(a) {
  ...
  if (F(o))
    ...
    for (const a in o) {
      ...
      if (Fs(d)) {
        ...
        else O = V(A) && A.name === 'Boolean'
        ;(m[0] = O), (m[1] = D), (O || q(m, 'default')) && c.push(d)
      }
    }
  const h = [i, c]
    ...
    et = (u, f, p, v, b, y, S, E, x) => {
      ...
      if (w > C) {
        if (w <= z) {
          const j = z + 1,
            B = j < L ? f[j].el : v
          for (; w <= z; ) O(null, (f[w] = x ? st(f[w]) : Ve(f[w])), p, B, b, y, S, E, x), w++
        }
...
function Ds(e) {
  ...
  try {
    if (n.shapeFlag & 4) {
      const T = r || s,
        J = T
      ;(H = Ve(h.call(J, T, a, d, m, g, A))), (I = c)
    } else {
      const T = t
      ;(H = Ve(T.length > 1 ? T(d, { attrs: c, slots: i, emit: l }) : T(d, null))),
        (I = t.props ? c : xl(c))
    }
  } catch (T) {
...
const Mo = ({ key: e }) => e ?? null,
  dn = ({ ref: e, ref_key: t, ref_for: n }) => (
    typeof e == 'number' && (e = '' + e),
    e != null ? (re(e) || ue(e) || V(e) ? { i: _e, r: e, k: t, f: !!n } : e) : null
  )
...
function Al(e, t = null, n = null, s = 0, r = null, o = !1) {
  ...
  const i = re(e) ? 1 : Oo(e) ? 128 : Vi(e) ? 64 : se(e) ? 4 : V(e) ? 2 : 0
...
function oc(e, t, n, s) {
  if (s) return !!(t === 'innerHTML' || t === 'textContent' || (t in e && nr(t) && V(n)))
  if (
    t === 'spellcheck' ||
    t === 'draggable' ||
    t === 'translate' ||
...
function Sc(e) {
  return Rs(e).replace(Do, '{').replace(No, '}').replace(Vo, '^')
}
function ns(e) {
  return Rs(e)
    .replace(Fo, '%2B')
  ...
  const c = ({ state: g }) => {
    ...
    r.forEach((H) => {
      H(n.value, A, {
        delta: D,
        type: nn.pop,
        direction: D ? (D > 0 ? Gt.forward : Gt.back) : Gt.unknown,
      })
    })
  }
  function l() {
...
function Gc(e, t) {
  ...
  for (const h of e) {
    ...
    for (let d = 0; d < h.length; d++) {
      ...
      if (g.type === 0) d || (r += '/'), (r += g.value.replace(qc, '\\$&')), (m += 40)
      else if (g.type === 1) {
        const { value: A, repeatable: O, optional: D, regexp: H } = g
        o.push({ name: A, repeatable: O, optional: D })
        const I = H || fr
        if (I !== fr) {
          m += 10
          try {
    ...
    for (const g of e) {
      ...
      for (const m of g)
        if (m.type === 0) a += m.value
          ...
          const { value: A, repeatable: O, optional: D } = m,
            H = A in h ? h[A] : ''
          if (Oe(H) && !O)
            throw new Error(
          ...
          if (!I)
            if (D) g.length < 2 && (a.endsWith('/') ? (a = a.slice(0, -1)) : (d = !0))
...
function eu(e, t) {
  ...
  function h(d, g) {
    ...
    if ('name' in d && d.name) {
      ...
      (O = d.path), (m = n.find(($) => $.re.test(O))), m && ((A = m.parse(O)), (D = m.record.name))
    else {
      if (((m = g.name ? s.get(g.name) : n.find(($) => $.re.test(g.path))), !m))
        throw It(1, { location: d, currentLocation: g })
      ;(D = m.record.name), (A = K({}, g.params, d.params)), (O = m.stringify(A))
    }
    const H = []
    let I = m
    for (; I; ) H.unshift(I.record), (I = I.parent)
    return { name: D, path: O, params: A, matched: H, meta: nu(H) }
  }
  e.forEach((d) => o(d))
  function a() {
    ;(n.length = 0), s.clear()
...
function _r(e) {
  const t = Ye(Cs),
    ...
    o = Ce(() => r.value > -1 && au(n.params, s.value.params)),
...
const uu = zt({
    ...
    setup(e, { slots: t }) {
      ...
      return () => {
        const o = t.default && cu(t.default(n))
        return e.custom
          ? o
          : Ho(
              'a',
    ...
    setup(e, { attrs: t, slots: n }) {
      ...
      return (
        ...
        () => {
          ...
          return wr(n.default, { Component: D, route: h }) || D
        }
      )
    },
  })
...
function hu(e) {
  ...
  function H(_, P) {
    ...
    const u = Tc(s, K({}, _, { hash: Sc(X), path: M.path })),
      f = r.createHref(u)
    return K({ fullPath: u, hash: X, query: s === mr ? iu(_.query) : _.query || {} }, M, {
      redirectedFrom: void 0,
      href: f,
    })
  }
  ...
  function Ht() {
    Ie ||
      (Ie = r.listen((_, P, R) => {
        ...
        h = M
        const u = l.value
        Et && Vc(lr(u.fullPath, R.delta), On()),
          Me(M, u)
            .catch((f) =>
              Ke(f, 12)
                ? f
  ...
  function ze(_, P, R, M) {
    ...
    const u =
      (!R && Dc(lr(_.fullPath, 0))) || ((M || !R) && history.state && history.state.scroll) || null
    return to()
      .then(() => X(_, P, u))
      .then((f) => f && Fc(f))
      .catch((f) => U(f, _, P))
...
const gu = { class: 'greetings' },
        ...
        ke('div', gu, [
          ...
          n[0] ||
            (n[0] = N(
              ...
              null,
              [
                k(' You’ve successfully created a project with a chicken in your butt fish '),
  ...
  _u = ft(vu, [['__scopeId', 'data-v-7ea008b5']]),
  yu = { class: 'wrapper' },
  bu = zt({
    __name: 'App',
    setup(e) {
  ...
  wu = ft(bu, [['__scopeId', 'data-v-85852c48']]),
  xu = 'modulepreload',
  Eu = function (e) {
    return '/' + e
  },
...
const Vt = ft(Ru, [
  ...
  Ou = {},
  Tu = { xmlns: 'http://www.w3.org/2000/svg', width: '20', height: '17', fill: 'currentColor' }
function Mu(e, t) {
  return (
    Re(),
    ke(
...
const Lu = ft(zu, [['render', $u]]),
  ju = {},
  Fu = { xmlns: 'http://www.w3.org/2000/svg', width: '18', height: '20', fill: 'currentColor' }
function Vu(e, t) {
  return (
    Re(),
    ke(
...
const Du = ft(ju, [['render', Vu]]),
  Nu = {},
  ku = { xmlns: 'http://www.w3.org/2000/svg', width: '20', height: '20', fill: 'currentColor' }
function Bu(e, t) {
  return (
    Re(),
    ke(
...
const Uu = ft(Nu, [['render', Bu]]),
  Ku = {},
  Wu = { xmlns: 'http://www.w3.org/2000/svg', width: '20', height: '20', fill: 'currentColor' }
function qu(e, t) {
  return (
    Re(),
    ke(
...
const Gu = ft(Ku, [['render', qu]]),
  ...
  Qu = zt({
    __name: 'HomeView',
    setup(e) {
      return (t, n) => (Re(), ke('main', null, [Q(Yu)]))
    },
  }),
  Ju = hu({
    history: Uc('/'),
    routes: [
      { path: '/', name: 'home', component: Qu },
      {
        path: '/about',
        name: 'about',
        component: () => Su(() => import('./AboutView-DyEowPLc.js'), __vite__mapDeps([0, 1])),
      },
    ],
  }),
  Ps = cc(wu)
